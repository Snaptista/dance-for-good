...
const TRANSLATIONS = {
  de: {
    ...
    'about.detail.time':     '19:00 – 02:00 Uhr',
    ...
    'location.p':            'Im Herzen Wiens, hoch oben im <strong>DC Tower</strong> – thront die Altia Skybar im 58. Stock des Meliã Vienna. Als <strong>höchste Rooftop Bar Europas</strong> bietet sie einen unvergleichlichen 360°-Panoramablick über die Donaustadt und die perfekte Bühne für Dance For Good.',
  ...
  en: {
    ...
    'location.p':            'In the heart of Vienna, high above the city inside the <strong>DC Tower</strong> – the Altia Skybar sits on the 58th floor of Meliã Vienna. As <strong>Europe\'s highest rooftop bar</strong>, it offers a breathtaking 360° panoramic view over the Danube city and the perfect stage for Dance For Good.',
