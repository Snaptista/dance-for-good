...
const TRANSLATIONS = {
  de: {
    ...
    'sponsors.catalog':      'Sponsoring-Katalog herunterladen',
    'sponsors.tier.main':    'HAUPTSPONSOREN',
    'sponsors.tier.gold':    'GOLD SPONSOREN',
    'sponsors.tier.logo':    'LOGO SPONSOREN',
    'photographer.label':    'FOTOGRAFIE',
    'photographer.h2':       'Unsere Fotografen',
  ...
  en: {
    ...
    'sponsors.catalog':      'Download Sponsoring Catalog',
    'sponsors.tier.main':    'MAIN SPONSORS',
    'sponsors.tier.gold':    'GOLD SPONSORS',
    'sponsors.tier.logo':    'LOGO SPONSORS',
    'photographer.label':    'PHOTOGRAPHY',
    'photographer.h2':       'Our Photographers',
